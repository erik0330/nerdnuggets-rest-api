...
impl ProjectRepository {
    ...
    pub async fn create_dao(&self, project: &Project) -> Result<bool, SqlxError> {
        let row = sqlx::query("INSERT INTO dao (project_id, nerd_id, proposal_id, user_id, title, description, details, funding_goal, cover_photo) VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9)")
            .bind(project.id)
    ...
    pub async fn update_milestone(
        ...
        let row = sqlx::query("UPDATE milestone SET progress_description = $1, deliverables = $2, challenges = $3, next_steps = $4, file_urls = $5, proof_status = $6 WHERE id = $7")
            .bind(progress_description)
            .bind(deliverables)
            .bind(challenges)
            .bind(next_steps)
            .bind(file_urls)
